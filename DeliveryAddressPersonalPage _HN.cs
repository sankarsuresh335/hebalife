...
{
    public class DeliveryAddressPersonalPage_HN : Page
    {
        ...
        public void EditAddress(Framework.Address add, bool IsCustomer = false, bool IsCancelled = false)
        {
            ...
            add.ClearAddress();
            add.FillAddressForEMEA("DJHN", "Akash", "Street", "", "PIMIENTA", "", "0034577678", "", "CORTES");
    ...
    public class DeliveryAddressPersonalPageTestHN : DeliveryAddressPersonalPage_HN { }
}
