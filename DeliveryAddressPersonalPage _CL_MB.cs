...
{
    public class DeliveryAddressPersonalPage_CL_MB : Page
    {
        ...
        [FindsBy(How = How.XPath, Using = "//img[@src='/Shop/Address/images/HERBALIFE_White_BG.png']")]
        public IWebElement PickupHerbalifeLOGO { get; set; }

        [FindsBy(How = How.XPath, Using = "//img[@src='/Shop/Address/images/puc-iquique.png']")]
        ...
        public void SearchAndEdit(Framework.Address add, bool IsCustomer = false)
        {
            ...
            if (count1 != null && count1.Count > 0)
            {
                foreach (var item in count1)
                {
                    ...
                    add.ClearAddress();
                    add.FillAddressforSAMCAM("Fname_New", "Lname_New", "street_New", "street2_New", "CAUTIN", "ARAUCANIA", "4890000", "99849484", "CUNCO");
                ...
                PersonalAddrList.Click();
                if (CommonMethods.IsElementDisplayed(PickupShiptothisBut))
                {
                    PageExtension.WaitForElementPresentAndVisible(this, PickupShiptothisBut);
                    PageExtension.WaitForTimeSpan(1000);
                    PickupShiptothisBut.Click();
                    PageExtension.WaitForElementGone(this, CommonFindBy.LoadIndicator);
    ...
    public class DeliveryAddressPersonalPageTestCLMB : DeliveryAddressPersonalPage_CL_MB { }
}
