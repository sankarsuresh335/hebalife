...
{
    public class DeliveryAddressPersonalPage_CZ_MB : Page
    {
        ...
        public Framework.Address AddAddress(Shop.Automation.Framework.Address add, bool IsCustomer = false, bool IsCancelled = false)
        {
            ...
            PageExtension.WaitForElementGone(this, CommonFindBy.LoadIndicator, 30);
            Assert.IsTrue(true, "Address successfully added");
            return add;
        }

        public Framework.Address EditAddress(Shop.Automation.Framework.Address add, bool IsCustomer = false, bool IsCancelled = false)
        {
        ...
        {
            this.WaitForElementClicklable(this.AddAddressBtn, 10);
            PageExtension.ScrollElementIntoMiddle(this, AddAddressBtn, 2);
            AddAddressBtn.Click();
            PageExtension.ScrollToTop(this);
            PageExtension.WaitForTimeSpan(2000);
            ...
            FirstName.SendKeys(add.FirstName);
            LastName.SendKeys(add.LastName);
            Street.SendKeys("Street 5687190");
            City.SendKeys("Ceske Budejovice");
            EnterPostalcode("370 05");
            ValidateAttributeContains("Ceske Budejovice");
            PhoneNumber.SendKeys(add.PhoneNumber);
            this.WaitForElementClicklable(this.ShippingAddrSave, 10);
            ShippingAddrSave.Click();
            this.WaitForElementGone(CommonFindBy.LoadIndicator, 30);
        }
        ...
        public void VerifyDuplicatePopUp(Framework.Address add)
        {
            ...
            Assert.IsTrue(CommonMethods.IsElementDisplayed(CancelDuplicateAddress));
            CancelDuplicateAddress.Click();
            PageExtension.WaitForTimeSpan(2000);
            //WaitSpinToFalse();
            ShippingAddrSave.Click();
            PageExtension.WaitForElementPresentAndVisible(this, Duplicatelist, 5);
    ...
    public class DeliveryAddressPersonalPageTestCZMB : DeliveryAddressPersonalPage_CZ_MB { }
}
